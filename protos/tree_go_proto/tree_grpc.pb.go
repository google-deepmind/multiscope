...
func (c *treeClient) GetNodeStruct(ctx context.Context, in *NodeStructRequest, opts ...grpc.CallOption) (*NodeStructReply, error) {
	...
	err := c.cc.Invoke(ctx, Tree_GetNodeStruct_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *treeClient) GetNodeData(ctx context.Context, in *NodeDataRequest, opts ...grpc.CallOption) (*NodeDataReply, error) {
	...
	err := c.cc.Invoke(ctx, Tree_GetNodeData_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *treeClient) SendEvents(ctx context.Context, in *SendEventsRequest, opts ...grpc.CallOption) (*SendEventsReply, error) {
	...
	err := c.cc.Invoke(ctx, Tree_SendEvents_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *treeClient) ResetState(ctx context.Context, in *ResetStateRequest, opts ...grpc.CallOption) (*ResetStateReply, error) {
	...
	err := c.cc.Invoke(ctx, Tree_ResetState_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *treeClient) ActivePaths(ctx context.Context, in *ActivePathsRequest, opts ...grpc.CallOption) (Tree_ActivePathsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Tree_ServiceDesc.Streams[0], Tree_ActivePaths_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *treeClient) StreamEvents(ctx context.Context, in *StreamEventsRequest, opts ...grpc.CallOption) (Tree_StreamEventsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Tree_ServiceDesc.Streams[1], Tree_StreamEvents_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *treeClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteReply, error) {
	out := new(DeleteReply)
	err := c.cc.Invoke(ctx, Tree_Delete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
