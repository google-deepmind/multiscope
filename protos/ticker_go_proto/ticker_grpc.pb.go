...
func (c *tickersClient) NewTicker(ctx context.Context, in *NewTickerRequest, opts ...grpc.CallOption) (*NewTickerResponse, error) {
	...
	err := c.cc.Invoke(ctx, Tickers_NewTicker_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tickersClient) WriteTicker(ctx context.Context, in *WriteTickerRequest, opts ...grpc.CallOption) (*WriteTickerResponse, error) {
	...
	err := c.cc.Invoke(ctx, Tickers_WriteTicker_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tickersClient) NewPlayer(ctx context.Context, in *NewPlayerRequest, opts ...grpc.CallOption) (*NewPlayerResponse, error) {
	...
	err := c.cc.Invoke(ctx, Tickers_NewPlayer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tickersClient) ResetPlayer(ctx context.Context, in *ResetPlayerRequest, opts ...grpc.CallOption) (*ResetPlayerResponse, error) {
	...
	err := c.cc.Invoke(ctx, Tickers_ResetPlayer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tickersClient) StoreFrame(ctx context.Context, in *StoreFrameRequest, opts ...grpc.CallOption) (*StoreFrameResponse, error) {
	...
	err := c.cc.Invoke(ctx, Tickers_StoreFrame_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedTickersServer must be embedded to have
...
func (UnimplementedTickersServer) testEmbeddedByValue()                 {}
...
func RegisterTickersServer(s grpc.ServiceRegistrar, srv TickersServer) {
	// If the following call panics, it indicates UnimplementedTickersServer was
