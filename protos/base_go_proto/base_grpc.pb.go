...
func (c *baseWritersClient) NewGroup(ctx context.Context, in *NewGroupRequest, opts ...grpc.CallOption) (*NewGroupResponse, error) {
	...
	err := c.cc.Invoke(ctx, BaseWriters_NewGroup_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *baseWritersClient) NewProtoWriter(ctx context.Context, in *NewProtoWriterRequest, opts ...grpc.CallOption) (*NewProtoWriterResponse, error) {
	...
	err := c.cc.Invoke(ctx, BaseWriters_NewProtoWriter_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *baseWritersClient) WriteProto(ctx context.Context, in *WriteProtoRequest, opts ...grpc.CallOption) (*WriteProtoResponse, error) {
	...
	err := c.cc.Invoke(ctx, BaseWriters_WriteProto_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *baseWritersClient) NewRawWriter(ctx context.Context, in *NewRawWriterRequest, opts ...grpc.CallOption) (*NewRawWriterResponse, error) {
	...
	err := c.cc.Invoke(ctx, BaseWriters_NewRawWriter_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *baseWritersClient) WriteRaw(ctx context.Context, in *WriteRawRequest, opts ...grpc.CallOption) (*WriteRawResponse, error) {
	...
	err := c.cc.Invoke(ctx, BaseWriters_WriteRaw_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedBaseWritersServer must be embedded to have
...
func (UnimplementedBaseWritersServer) testEmbeddedByValue()                     {}
...
func RegisterBaseWritersServer(s grpc.ServiceRegistrar, srv BaseWritersServer) {
	// If the following call panics, it indicates UnimplementedBaseWritersServer was
