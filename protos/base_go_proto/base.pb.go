...
const file_base_proto_rawDesc = "" +
	...
	"\x04path\x18\x02 \x01(\v2\x14.multiscope.NodePathR\x04path\"h\n" +
	"\x0fNewGroupRequest\x12+\n" +
	"\atree_id\x18\x01 \x01(\v2\x12.multiscope.TreeIDR\x06treeId\x12(\n" +
	"\x04path\x18\x02 \x01(\v2\x14.multiscope.NodePathR\x04path\"<\n" +
	"\x10NewGroupResponse\x12(\n" +
	"\x03grp\x18\x01 \x01(\v2\x16.multiscope.base.GroupR\x03grp\"d\n" +
	"\vProtoWriter\x12+\n" +
	"\atree_id\x18\x01 \x01(\v2\x12.multiscope.TreeIDR\x06treeId\x12(\n" +
	"\x04path\x18\x02 \x01(\v2\x14.multiscope.NodePathR\x04path\"\x9a\x01\n" +
	"\x15NewProtoWriterRequest\x12+\n" +
	"\atree_id\x18\x01 \x01(\v2\x12.multiscope.TreeIDR\x06treeId\x12(\n" +
	"\x04path\x18\x02 \x01(\v2\x14.multiscope.NodePathR\x04path\x12*\n" +
	"\x05proto\x18\x03 \x01(\v2\x14.google.protobuf.AnyR\x05proto\"N\n" +
	"\x16NewProtoWriterResponse\x124\n" +
	"\x06writer\x18\x01 \x01(\v2\x1c.multiscope.base.ProtoWriterR\x06writer\"u\n" +
	"\x11WriteProtoRequest\x124\n" +
	"\x06writer\x18\x01 \x01(\v2\x1c.multiscope.base.ProtoWriterR\x06writer\x12*\n" +
	"\x05proto\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\x05proto\"\x14\n" +
	"\x12WriteProtoResponse\"b\n" +
	"\tRawWriter\x12+\n" +
	"\atree_id\x18\x01 \x01(\v2\x12.multiscope.TreeIDR\x06treeId\x12(\n" +
	"\x04path\x18\x02 \x01(\v2\x14.multiscope.NodePathR\x04path\"\x80\x01\n" +
	"\x13NewRawWriterRequest\x12+\n" +
	"\atree_id\x18\x01 \x01(\v2\x12.multiscope.TreeIDR\x06treeId\x12(\n" +
	"\x04path\x18\x02 \x01(\v2\x14.multiscope.NodePathR\x04path\x12\x12\n" +
	"\x04mime\x18\x03 \x01(\tR\x04mime\"J\n" +
	"\x14NewRawWriterResponse\x122\n" +
	"\x06writer\x18\x01 \x01(\v2\x1a.multiscope.base.RawWriterR\x06writer\"Y\n" +
	"\x0fWriteRawRequest\x122\n" +
	"\x06writer\x18\x02 \x01(\v2\x1a.multiscope.base.RawWriterR\x06writer\x12\x12\n" +
	"\x04data\x18\x03 \x01(\fR\x04data\"\x12\n" +
	"\x10WriteRawResponse2\xd0\x03\n" +
	"\vBaseWriters\x12Q\n" +
	"\bNewGroup\x12 .multiscope.base.NewGroupRequest\x1a!.multiscope.base.NewGroupResponse\"\x00\x12c\n" +
	...
	"\fNewRawWriter\x12$.multiscope.base.NewRawWriterRequest\x1a%.multiscope.base.NewRawWriterResponse\"\x00\x12Q\n" +
	"\bWriteRaw\x12 .multiscope.base.WriteRawRequest\x1a!.multiscope.base.WriteRawResponse\"\x00B!Z\x1fmultiscope/protos/base_go_protob\x06proto3"
