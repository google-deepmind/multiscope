...
func (c *rootClient) GetRootInfo(ctx context.Context, in *GetRootInfoRequest, opts ...grpc.CallOption) (*GetRootInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, Root_GetRootInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rootClient) SetKeySettings(ctx context.Context, in *SetKeySettingsRequest, opts ...grpc.CallOption) (*SetKeySettingsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Root_SetKeySettings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rootClient) SetLayout(ctx context.Context, in *SetLayoutRequest, opts ...grpc.CallOption) (*SetLayoutResponse, error) {
	...
	err := c.cc.Invoke(ctx, Root_SetLayout_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rootClient) SetCapture(ctx context.Context, in *SetCaptureRequest, opts ...grpc.CallOption) (*SetCaptureResponse, error) {
	...
	err := c.cc.Invoke(ctx, Root_SetCapture_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
