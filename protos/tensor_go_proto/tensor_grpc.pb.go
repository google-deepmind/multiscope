...
func (c *tensorsClient) NewWriter(ctx context.Context, in *NewWriterRequest, opts ...grpc.CallOption) (*NewWriterResponse, error) {
	...
	err := c.cc.Invoke(ctx, Tensors_NewWriter_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tensorsClient) ResetWriter(ctx context.Context, in *ResetWriterRequest, opts ...grpc.CallOption) (*ResetWriterResponse, error) {
	...
	err := c.cc.Invoke(ctx, Tensors_ResetWriter_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tensorsClient) Write(ctx context.Context, in *WriteRequest, opts ...grpc.CallOption) (*WriteResponse, error) {
	...
	err := c.cc.Invoke(ctx, Tensors_Write_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedTensorsServer must be embedded to have
...
func (UnimplementedTensorsServer) testEmbeddedByValue()                 {}
...
func RegisterTensorsServer(s grpc.ServiceRegistrar, srv TensorsServer) {
	// If the following call panics, it indicates UnimplementedTensorsServer was
