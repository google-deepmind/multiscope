...
var file_text_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x32, 0x0a, 0x06, 0x57, 0x72, 0x69,
	0x74, 0x65, 0x72, 0x12, 0x28, 0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x14, 0x2e, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x2e, 0x4e,
	0x6f, 0x64, 0x65, 0x50, 0x61, 0x74, 0x68, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x22, 0x36, 0x0a,
	0x0a, 0x48, 0x54, 0x4d, 0x4c, 0x57, 0x72, 0x69, 0x74, 0x65, 0x72, 0x12, 0x28, 0x0a, 0x04, 0x70,
	...
	,
...
var file_text_proto_depIdxs = []int32{
	12, // 0: multiscope.text.Writer.path:type_name -> multiscope.NodePath
	12, // 1: multiscope.text.HTMLWriter.path:type_name -> multiscope.NodePath
	12, // 2: multiscope.text.NewWriterRequest.path:type_name -> multiscope.NodePath
	0,  // 3: multiscope.text.NewWriterResponse.writer:type_name -> multiscope.text.Writer
	12, // 4: multiscope.text.NewHTMLWriterRequest.path:type_name -> multiscope.NodePath
	1,  // 5: multiscope.text.NewHTMLWriterResponse.writer:type_name -> multiscope.text.HTMLWriter
	0,  // 6: multiscope.text.WriteRequest.writer:type_name -> multiscope.text.Writer
	1,  // 7: multiscope.text.WriteHTMLRequest.writer:type_name -> multiscope.text.HTMLWriter
	1,  // 8: multiscope.text.WriteCSSRequest.writer:type_name -> multiscope.text.HTMLWriter
	2,  // 9: multiscope.text.Text.NewWriter:input_type -> multiscope.text.NewWriterRequest
	4,  // 10: multiscope.text.Text.NewHTMLWriter:input_type -> multiscope.text.NewHTMLWriterRequest
	6,  // 11: multiscope.text.Text.Write:input_type -> multiscope.text.WriteRequest
	8,  // 12: multiscope.text.Text.WriteHTML:input_type -> multiscope.text.WriteHTMLRequest
	10, // 13: multiscope.text.Text.WriteCSS:input_type -> multiscope.text.WriteCSSRequest
	3,  // 14: multiscope.text.Text.NewWriter:output_type -> multiscope.text.NewWriterResponse
	5,  // 15: multiscope.text.Text.NewHTMLWriter:output_type -> multiscope.text.NewHTMLWriterResponse
	7,  // 16: multiscope.text.Text.Write:output_type -> multiscope.text.WriteResponse
	9,  // 17: multiscope.text.Text.WriteHTML:output_type -> multiscope.text.WriteHTMLResponse
	11, // 18: multiscope.text.Text.WriteCSS:output_type -> multiscope.text.WriteCSSResponse
