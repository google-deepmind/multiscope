...
class TickersStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ResetPlayer = channel.unary_unary(
                '/multiscope.ticker.Tickers/ResetPlayer',
                request_serializer=multiscope_dot_protos_dot_ticker__pb2.ResetPlayerRequest.SerializeToString,
                response_deserializer=multiscope_dot_protos_dot_ticker__pb2.ResetPlayerResponse.FromString,
                )
...
class TickersServicer(object):
    ...
    def ResetPlayer(self, request, context):
...
def add_TickersServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ResetPlayer': grpc.unary_unary_rpc_method_handler(
                    servicer.ResetPlayer,
                    request_deserializer=multiscope_dot_protos_dot_ticker__pb2.ResetPlayerRequest.FromString,
                    response_serializer=multiscope_dot_protos_dot_ticker__pb2.ResetPlayerResponse.SerializeToString,
            ),
...
class Tickers(object):
    ...
    def ResetPlayer(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/multiscope.ticker.Tickers/ResetPlayer',
            multiscope_dot_protos_dot_ticker__pb2.ResetPlayerRequest.SerializeToString,
            multiscope_dot_protos_dot_ticker__pb2.ResetPlayerResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
